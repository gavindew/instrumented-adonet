...
namespace InstrumentedAdoNet
{
    ...
    /// </summary>
    public class InstrumentedDbDataAdapter : DbDataAdapter
    {
        /// <summary>
        ...
        private void InitCommands(IDbDataAdapter wrappedAdapter)
        {
            ...
            {
                this._selectCommand = wrappedAdapter.SelectCommand;
            }
            if (wrappedAdapter.DeleteCommand != null)
            {
                this._deleteCommand = wrappedAdapter.DeleteCommand;
            }
            if (wrappedAdapter.UpdateCommand != null)
            {
                this._updateCommand = wrappedAdapter.UpdateCommand;
            }
            if (wrappedAdapter.InsertCommand != null)
            {
                this._insertCommand = wrappedAdapter.InsertCommand;
            }
        }
        ...
        /// </returns>
        public new DataTable[] FillSchema(DataSet dataSet, SchemaType schemaType) => this.InternalAdapter.FillSchema(dataSet, schemaType);
        ...
        public new int Fill(DataSet dataSet)
        {
            ...
            if (this._instrumentationHandler == null || !(this._selectCommand is DbCommand))
            {
                return this.InternalAdapter.Fill(dataSet);
            }

            int result;
            var cmd = (DbCommand)this._selectCommand;
            this._instrumentationHandler.ExecuteStart(cmd, SqlExecuteType.Reader);
            try
            {
                result = this.InternalAdapter.Fill(dataSet);
            }
            catch (Exception e)
            {
                this._instrumentationHandler.OnError(cmd, SqlExecuteType.Reader, e);
                throw;
            }
            finally
            {
                this._instrumentationHandler.ExecuteFinish(cmd, SqlExecuteType.Reader, TokenReader);
            }
        ...
        {
            var dbDataAdapter = this.InternalAdapter as DbDataAdapter
        ...
        /// </returns>
        public new IDataParameter[] GetFillParameters() => this.InternalAdapter.GetFillParameters();
        ...
        {
            get => this.InternalAdapter.MissingMappingAction;
            set => this.InternalAdapter.MissingMappingAction = value;
        }
        ...
        {
            get => this.InternalAdapter.MissingSchemaAction;
            set => this.InternalAdapter.MissingSchemaAction = value;
        }
        ...
        public new ITableMappingCollection TableMappings => this.InternalAdapter.TableMappings;
        ...
        public new IDbCommand SelectCommand
        {
            ...
            set
            {
                ...
                this.InternalAdapter.SelectCommand = value is InstrumentedDbCommand cmd ? cmd.InternalCommand : value;
            }
        }
        ...
        public new IDbCommand InsertCommand
        {
            ...
            set
            {
                ...
                this.InternalAdapter.InsertCommand = value is InstrumentedDbCommand cmd ? cmd.InternalCommand : value;
            }
        }
        ...
        public new IDbCommand UpdateCommand
        {
            ...
            set
            {
                ...
                this.InternalAdapter.UpdateCommand = value is InstrumentedDbCommand cmd ? cmd.InternalCommand : value;
            }
        }
        ...
        public new IDbCommand DeleteCommand
        {
            ...
            set
            {
                ...
                this.InternalAdapter.DeleteCommand = value is InstrumentedDbCommand cmd ? cmd.InternalCommand : value;
            }
        }
    }
}
